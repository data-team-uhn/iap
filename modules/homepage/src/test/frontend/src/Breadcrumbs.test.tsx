...
const views = [
  ...
  // A splat with no page of its own, and a splat beside the page it details
...
describe("Breadcrumbs", () => {
  ...
  // Both targets match, and which one `find` reaches first is the order the extensions came back in
