...
// A 409 means the entity changed while this request was in flight, usually this same form autosaving
// the previous field. The answer is fine, so send it again against the state that now exists. No
// backoff: the other commit has already landed, which is why this one was refused.
const CONFLICT = 409;
