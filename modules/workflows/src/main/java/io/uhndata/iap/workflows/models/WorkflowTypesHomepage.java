...
public class WorkflowTypesHomepage extends EntityHomepage implements AutoDocumentable
{
     ...
     *
     * <p>Entries of no {@link ModelDispatch#isConcrete kind at all} are left out, the same way the abstract flow
     * nodes are.</p>
     *
    ...
    public FlowNodeType getFlowNodeType(@NotNull final String name)
    {
        ...
        return type != null && ModelDispatch.isConcrete(type) ? type : null;
    }
