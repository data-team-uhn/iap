...
/**
 * What an accepted event amounted to: the variables the workflow left behind, such as the path of an entity a
 * bootstrap workflow created. The translator that fed the event in reads them to shape its channel's answer, be
 * that a redirect, a reply email, or nothing at all.
 *
 * @version $Id$
 * @since 0.1.0
 */
public final class WorkflowResult
{
    ...
    public static final String CREATED_PATH_VARIABLE = "createdPath";
