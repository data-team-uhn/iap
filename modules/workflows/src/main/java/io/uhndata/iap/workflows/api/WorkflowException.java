...
/**
 * The base of everything that can go wrong while receiving an event. The subtypes distinguish the three layers
 * an event is judged on, state and authorization and payload, plus failures of the definitions and of the
 * machinery. Each deserves a different answer: HTTP maps them to 409, 403, 400 and 500.
 *
 * @version $Id$
 * @since 0.1.0
 */
