 ...
 * path is reported in the {@link WorkflowResult#CREATED_PATH_VARIABLE} variable, for the downstream nodes and for the
...
public class CreateEntityHandler implements ServiceTaskHandler
{
    ...
    public static final String HANDLER_NAME = "createEntity";

    /** The activity property configuring the JCR node type of the created entity. */
    private static final String ENTITY_TYPE_PARAMETER = "entityType";
    ...
    {
        final Object entityType = context.getActivity().get(ENTITY_TYPE_PARAMETER);
