...
class ModelRepliesTest
{
    ...
    @Test
    void readsTheStringsInAnArrayAndSkipsTheRest()
    {
        assertEquals(List.of("B.1", "B.3"),
            ModelReplies.readStrings(object("{\"tags\": [\"B.1\", 2, null, \"B.3\"]}"), TAGS));
        assertEquals(List.of(), ModelReplies.readStrings(object("{\"tags\": \"B.1\"}"), TAGS));
        assertEquals(List.of(), ModelReplies.readStrings(object("{}"), TAGS));
    }
}
