 ...
 * node type. Unlike {@link io.uhndata.iap.entities.models.Entity} or {@link Requirement}, this class is
 ...
 * {@code ResourceTypeBasedResourcePicker}), instead of yielding a generic, field-less {@code QuestionnaireItem}
 * instance. This lets a new item type plug in later without any change here or to the callers that ask for "the
 * items" of a section or questionnaire, at the cost of {@code QuestionnaireItem} no longer being directly
