...
public final class Operand
{
     ...
     */
    @NotNull
    public static Operand of(@Nullable final Object rawValue)
    {
     ...
     */
    @NotNull
    public static Operand of(@Nullable final Object rawValue, @Nullable final OperandType declaredType)
    {
        if (rawValue == null) {
     ...
     */
    @NotNull
    public Operand coerce(@NotNull final OperandType target)
    {
