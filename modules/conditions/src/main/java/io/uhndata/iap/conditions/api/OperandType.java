...
public enum OperandType
{
     ...
     */
    @Nullable
    public Comparable<Object> coerce(@Nullable final Object rawValue)
    {
     ...
     */
    @NotNull
    public static OperandType parse(@Nullable final String label)
    {
        if (label == null) {
            return TEXT;
        }
     ...
     */
    @Nullable
    public static OperandType infer(@Nullable final Object value)
    {
