 ...
 * run under sling-mock, so the one thing this module's handler asks of it — whether a request is still a draft —
 * is answered here from the node's own {@code tags} property, which is what the service reads for real.
 *
 * <p>Reading only: nothing here places or removes a tag, because nothing in this module does.</p>
 *
 * @version $Id$
 * @since 0.1.0
 */
